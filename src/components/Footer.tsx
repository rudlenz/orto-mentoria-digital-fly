          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#mentores" className="text-gray-300 hover:text-white transition-colors">
                    Mentores
                  </a>
                </li>
                <li>
                  <a href="#experiencia" className="text-gray-300 hover:text-white transition-colors">
                    Experiência
                  </a>
                </li>
                <li>
